   ...
   <header>
        <nav>
            <ul>
                    ...
                    <li><a href="#news">bla</a></li>
                    <li><a href="#products">bla</a></li>
    ...
    <main>
    <div class="content">      
        <img id ="chocolatier1" src ="../Assignment2-5/images/Banners-Lindt-Roger-Maitre-Chocolatier.jpg" alt="chocolatier1">
    ...
    <br><br><br>
    <div class="content">
        <img id ="excellence" src ="../Assignment2-5/images/lindt-background3.jpg" alt="excellence">
    ...
    <br><br><br> 
    <div class="content">      
            <img id ="chocolatier" src ="../Assignment2-5/images/Lindt-chocolatier-1.jpg" alt="chocolatier">
    ...
    <div class="content">
            <img id ="bunny" src ="../Assignment2-5/images/Lindt-Gold-Bunny.jpg" alt="bunny">
